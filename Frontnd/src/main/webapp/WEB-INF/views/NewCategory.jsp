...
<form class="form-horizontal" action="addCategory" method="post" onsubmit="return formCategory()">
  <div class="form-group">
    <label class="control-label col-sm-offset-2 col-sm-3" for="email">Genre :</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" name="categoryName" id="categoryname" placeholder="Enter Genre type" required>
    </div>
  </div>
  <div class="form-group">
